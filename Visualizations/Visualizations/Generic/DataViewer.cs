...
{
	public class DataViewer : AbstractWPFVisualization<System.Windows.Controls.ScrollViewer>
	{
		/* ------------------------------------------------------------------*/
		// properties

		public override string _Name { get { return "Data Viewer"; } }
		...
		~DataViewer()
		{
			Console.WriteLine("DEBUG - DTOR: DataViewer");
		}
		...
		private System.Data.DataTable _table = new DataTable();
